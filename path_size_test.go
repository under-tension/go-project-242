...
func TestFormatSize(t *testing.T) {
	tests := []struct {
		...
		// --- EB ---
		{"Human: 1EB exact", 1024 * 1024 * 1024 * 1024 * 1024 * 1024, true, "1.0EB"},
